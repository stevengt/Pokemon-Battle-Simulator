...
//    
//    
//    current_socket->on("ping", sio::socket::event_listener_aux([&](string const& name, message::ptr const& data, bool isAck,message::list &ack_resp)
//                                                               {
//                                                                   std::cout << "got a heartbeat";
//                                                                   _lock.lock();
//                                                                   socket->emit("pong",sio::string_message::create("."));
//                                                                   _lock.unlock();
//                                                               }));
//    
//    
