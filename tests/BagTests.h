...
public:
    ...
    void testConstructor(void) {
        Bag bag = Bag(3);
        TS_ASSERT_EQUALS(bag.getCurrentHpAndPpItemsSize(),0);
        TS_ASSERT_EQUALS(bag.getCurrentStatusItemsSize(),0);
    ...
    void testAddItem(void) {
        ...
        TS_ASSERT_EQUALS(bag.getCurrentHpAndPpItemsSize(),2);
        TS_ASSERT_EQUALS(bag.getCurrentStatusItemsSize(),1);
        TS_ASSERT(bag.equals(bag1));
        
        bag.addItem(item1);
        TS_ASSERT_THROWS_ANYTHING(bag.addItem(item1));
    ...
    void testRemoveItem(void) {
        ...
        TS_ASSERT_THROWS_ANYTHING(bag.removeItem(item1));
        ...
        TS_ASSERT_THROWS_ANYTHING(bag.removeItem(item3));
        TS_ASSERT_THROWS_NOTHING(bag.removeItem(item1));
